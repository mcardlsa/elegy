...
--
-- Host: localhost
-- Generation Time: Oct 26, 2015 at 07:53 AM
...
(3, 1, 'manoj', 'patidar', 'manoj@tanzaniteinfotech.com', 'e10adc3949ba59abbe56e057f20f883e', 0, 'RqMxBajfht1B', NULL, 'profile_image/default.png', '2015-10-24 17:04:31', NULL, NULL, NULL, NULL, 0),
...
(7, 1, 'manoj', 'patidar', 'manoj 4@tanzaniteinfotech.com', '25d55ad283aa400af464c76d713c07ad', 1, 'a4qnYg57oXZE', NULL, 'profile_image/default.png', '2015-10-25 06:40:42', '2015-10-25 01:58:15', '', '2015-10-25 01:57:54', 'tnHXvbB5', 0);
...
--
ALTER TABLE `funeral`
  ADD CONSTRAINT `funeral_ibfk_1` FOREIGN KEY (`createdBy`) REFERENCES `users` (`userId`) ON UPDATE CASCADE,
