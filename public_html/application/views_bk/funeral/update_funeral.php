...
<div class="row">
	<div class="width">
    	<div class="inner_mid mar_tp_230">
        	...
        	<div class="form-1">
                <h3><strong>Coordinate</strong> <small>step 1 of 4</small></h3>
            ...
            <!-- form 2 -->
            <div class="form-2">
                <h3><strong>Coordinate</strong> <small>step 2 of 4</small></h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras lectus est, laoreet a convallis ut, semper et magna. Vivamus ligula lacus, dapibus vitae nibh quis, placerat pulvinar felis.Dolor sit amet, consectetur adipiscing elit. Cras lectus est, laoreet a convallis ut, semper et magna. Vivamus ligula lacus, dapibus vitae nibh quis, placerat pulvinar felis.</p>
                ...
                <div class="clearfix"></div>  
					...
					<div class="register_form">
                        <div class="dropdown form-group position-relative custom-select">
							...
							<?php echo form_dropdown('serviceTypeId',$servicetype,set_value('serviceTypeId',$funeral_detail['serviceTypeId']),'class="form-control" id="serviceTypeId"');?>
							...
							?>
                                ...
                                <div class="circle_box circle_box_<?php echo $j;?>">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="event<?php echo $j;?>[]" class="form-control" id="datetimepicker<?php echo $j;?>" value="<?php if(isset($event[$k]['time'])) echo $event[$k]['time'];?>">
                                    <?php echo form_error('event'); ?>
									</div>
            ...
            <!-- form 3 -->
            <div class="form-3">
                <h3><strong>Coordinate</strong> <small>step 3 of 4</small></h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras lectus est, laoreet a convallis ut, semper et magna. Vivamus ligula lacus, dapibus vitae nibh quis, placerat pulvinar felis.Dolor sit amet, consectetur adipiscing elit. Cras lectus est, laoreet a convallis ut, semper et magna. Vivamus ligula lacus, dapibus vitae nibh quis, placerat pulvinar felis.</p>
        	...
        	<!-- form 3 -->
             ...
             <!-- form 4 -->
            <div class="form-4">
                <h3><strong>Coordinate</strong> <small>step 4 of 4</small></h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras lectus est, laoreet a convallis ut, semper et magna. Vivamus ligula lacus, dapibus vitae nibh quis, placerat pulvinar felis.Dolor sit amet, consectetur adipiscing elit. Cras lectus est, laoreet a convallis ut, semper et magna. Vivamus ligula lacus, dapibus vitae nibh quis, placerat pulvinar felis.</p>
                	<div class="register_form">
                        <div class="form-group">
                            <label>Enter Invite Guests</label>
                            <div class="invite_guest_wrap">
								<?php foreach($funeral_detail['guests']as $val) {?>
                             <div class="mar_bm_20"><input type="text" id="guest" name="guest[]" class="form-control" value="<?php echo $val['emailId'];?>"></div>
...
function email_check(data)
	{    
		var x = $('#guest').val();
        if(x==null){
            alert('please enter the email of guest');
