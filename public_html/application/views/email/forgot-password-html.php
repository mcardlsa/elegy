...
<br />
<big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="<?php echo site_url('/user/ResetPassword/'.$userToken.'/'.$resettoken); ?>" style="color: #3366cc;">Create a new password</a></b></big><br />
<br />
Link doesn't work? Copy the following link to your browser address bar:<br />
<nobr><a href="<?php echo site_url('/user/ResetPassword/'.$userToken.'/'.$resettoken); ?>" style="color: #3366cc;"><?php echo site_url('/user/ResetPassword/'.$userToken.'/'.$resettoken); ?></a></nobr><br />
<br />
<br />
