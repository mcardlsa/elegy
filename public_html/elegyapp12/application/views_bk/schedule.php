                             ...
                             <div class="col-sm-10 pad-right0">
                                <div class="panel-heading" role="tab"  <?php if ($val['eventType']=='wake') {  ?> id="headingOne" <?php } elseif($val['eventType']=='ceremony') {  ?>id="headingTwo" <?php } elseif($val['eventType']=='burial') {  ?>id="headingThree" <?php }  elseif($val['eventType']=='reception') {  ?>id="headingFour" <?php } ?>>
                                  <h4 class="panel-title">
                                    <a role="button" class="position-relative" data-toggle="collapse" data-parent="#accordion"<?php if ($val['eventType']=='wake') {  ?> href="#panelOne" <?php } elseif($val['eventType']=='ceremony') {  ?>href="#panelTwo" <?php } elseif($val['eventType']=='burial') {  ?>href="#panelThree" <?php }  elseif($val['eventType']=='reception') {  ?>href="#panelFour" <?php } ?>  aria-expanded="true" aria-controls="collapseOne">
                                   	 <p><?php echo $val['eventType']; ?> <small_head><?php echo date('h : i ',strtotime($val['time'])); $x=date('H',strtotime($val['time'])); if ($x>12){ echo 'PM';} else{ echo 'AM';}  ?> </small_head></p>
                                    </a>
                                  </h4>
                                </div>
