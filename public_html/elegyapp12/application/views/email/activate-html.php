...
To verify account, please follow this activation code:<br />
<br />
<nobr><a href="<?php echo site_url('/user/activateaccount/'.$activation_code); ?>" style="color: #3366cc;"> click here for activation</a></nobr>
<br />
<br />
Please verify your registration otherwise it will become inactive.<br />
<br />
<br />
Have fun!<br />
